...
//    ];
  ...
  describe( 'fixFilter', function() {
    ...
    it( 'fix tree with mix of visible and invisible rows, collapsed and not collapsed', function() {
      ...
      expect( grid.treeBase.tree[0].children[2].row.visible ).toEqual( false, 'tree[0].children[2] has no visible children, shouldn\'t have changed to visible' );
    });
  });
